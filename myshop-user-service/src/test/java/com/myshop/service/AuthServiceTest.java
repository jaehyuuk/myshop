...
class AuthServiceTest {
    ...
    void getAuthTest() {
        ...
        User user = User.builder()
                ...
                .introduce("Hello, this is a test user.")
                .build();

        given(userRepository.findById(userId)).willReturn(Optional.of(user));

        // when
        UserDto result = authService.getAuth(userId);
        ...
        assertEquals("Hello, this is a test user.", result.getIntroduce());
    }
